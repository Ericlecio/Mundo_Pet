...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Out-2022 às 13:15
...
ALTER TABLE `agenda`
  ...
  ADD KEY `agenda_ibfk_1` (`idveterinario`),
  ADD KEY `agenda_ibfk_2` (`idconsulta`);
...
ALTER TABLE `animal`
  ...
  ADD KEY `animal_ibfk_1` (`idusuario`);
...
ALTER TABLE `consulta`
  ...
  ADD KEY `consulta_ibfk_1` (`idveterinario`),
  ADD KEY `consulta_ibfk_2` (`idusuario`);
...
--
ALTER TABLE `endereco`
  MODIFY `idendereco` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `consulta`
  ...
  ADD CONSTRAINT `consulta_ibfk_2` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`idusuario`);
COMMIT;
